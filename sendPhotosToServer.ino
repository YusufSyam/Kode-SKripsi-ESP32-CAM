...
const char* ssid = "haehakopi";
const char* password = "eskopipisang";
//========================================

//======================================== Variables for Timer/Millis.
unsigned long previousMillis = 0;
const int Interval = 0;  //--> Photo capture every 20 seconds.
...
String serverName = "192.168.1.27";  //--> Change with your server computer's IP address or your Domain name.
// The file path "upload_img.php" on the server folder.
String serverPath = "/detection/upload-temporary-image/";
// Server Port.
...
void sendPhotoToServer() {
  ...
  if (client.connect(serverName.c_str(), serverPort)) {
    ...
    // 60000 berari berjalan selama 1 menit
...
void loop() {
  ...
  // 60000 berari berjalan selama 1 menit
  if (shouldRun) {
    // Lakukan proses pengambilan gambar dan pengiriman ke server di sini
    ...
    int tempTime= millis() - loopStartTime;
    // Cek apakah waktu yang telah berlalu sudah mencapai 1 menit (60.000 milidetik)
    if (tempTime >= 60000) {
      shouldRun = false;  // Mengubah variabel shouldRun menjadi false setelah 1 menit
